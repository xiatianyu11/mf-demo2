...
function Home() {
  return <div>Remote2 Home</div>;
}
function Detail() {
  return <div>Remote2 Detail</div>;
}
 ...
 */
export default function RemoteApp({ initialPath = "/app2" }) {
  ...
  const remoteInitial = (initialPath && initialPath.replace(/^\/app2/, "")) || "/";
